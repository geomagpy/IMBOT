...
setup(
    ...
    packages=['imbot', 'imbot.analysis', 'imbot.core', 'imbot.documentation'],
    ...
    package_data={'imbot': ['documentation/*.pdf']  },
    data_files=[('bash', ['bash/*.sh','bash/*.bash']), ('config', ['config/*.cfg']), ('templates', ['templates/*']), ('external', ['external/*']) ],
