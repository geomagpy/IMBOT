...
setup(
    ...
    packages=['imbot', 'imbot.analysis', 'imbot.core', 'imbot.documentation', 'imbot.bash', 'imbot.config', 'imbot.external', 'imbot.templates'],
    ...
    package_data={'imbot': ['documentation/*.pdf', 'bash/*.sh', 'bash/*.bash', 'config/*.cfg', 'templates/*', 'external/*']  },
